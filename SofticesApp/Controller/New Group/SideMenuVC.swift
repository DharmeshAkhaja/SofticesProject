...
class SideMenuVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var arrData = ["Map","API","FaceBook","Share","ShareIMG","GoogleLogin"]
    var arrImage = [#imageLiteral(resourceName: "GOOGLE MAP"),#imageLiteral(resourceName: "api-prosyscom-tech"),#imageLiteral(resourceName: "Facebook 2"),#imageLiteral(resourceName: "ShareButtonRoundBlue"),#imageLiteral(resourceName: "ShareButtonRoundBlue"),#imageLiteral(resourceName: "google-logo")]
